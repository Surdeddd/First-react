            ...
            <div className={classes.containerCards1}>
                <div  data-aos="fade-up" data-aos-duration="1900"  className={classes.iteam1}>
                    ...
                    <div className={classes.iteam1Header}>
                        <h1>Настройка кэширования данных. Апдгрейд сервера. Ускорение работы сайта в 30 раз!</h1>
                        <p style={{opacity: 0.5}}>04.05.2020</p>
                        <h2 style={{opacity: 0.7}}>Влияние скорости загрузки страниц сайта на отказы и конверсии. Кейс ускорения... </h2>
                    </div>
                </div>
                <div  data-aos="fade-up" data-aos-duration="2000"  className={classes.iteam2}>
                    <img src={photo2} alt={photo2}/>
                    <h1>Использование отчетов Ecommerce в Яндекс.Метрике</h1>
                </div>
                <div  data-aos="fade-up" data-aos-duration="2100"  className={classes.iteam21}>
                    <img src={photo3} alt={photo3}/>
                    <h1>Повышение конверсии страницы с формой заявки с применением AB-тестирования</h1>
                    <p style={{opacity: 0.5}}>24.01.2020</p>
                </div>
                <div  data-aos="fade-up" data-aos-duration="2200"  className={classes.iteam21}>
                    <img src={photo4} alt={photo4}/>
                    <h1>Druopal 7: ускорение времени генерации страниц интернет-магазина на 32% </h1>
                ...
                <div  data-aos="fade-up" data-aos-duration="2300"  className={classes.iteam1}>
                    ...
                    <div className={classes.iteam1Header}>
                        <h1>Обмен товарами и заказами интернет-магазинов на Drupal 7 c 1С:Предприятие, МойСклад, Класс365</h1>
                        <p style={{opacity: 0.5}}>22.08.2019</p>
                        <h2 style={{opacity: 0.7}}>опубликован <span>релиз модуля...</span></h2>
                    </div>
                </div>
            </div>
        </div>
